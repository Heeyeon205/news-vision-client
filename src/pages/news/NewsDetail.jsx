    ...
    <div class="p-4 max-w-[600px] w-full mx-auto shadow-lg mt-5 mb-6">
      ...
      <div className="mt-7 flex">
        <div className="flex-shrink-0 w-10 h-10 mr-2">
          <img src={news.profileImage} alt="유저 프로필" className="rounded-full" />
        </div>
        <div className="flex-1 flex flex-col">
          <div className="flex items-center">
            <span className="font-medium text-gray-800 mr-1">{news.authorNickname}</span>
            <img src={news.authorBadgeIcon} alt="유저 뱃지" className="w-5 h-5" />
          </div>
          {news.badgeTitle && (
