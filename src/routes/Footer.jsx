export default function Footer() {
  return (
    <footer className="w-full h-60  text-white py-7 bottom-0 flex flex-col lg:flex-row justify-around p-23" style={{ fontFamily: "AppleSDGothicNeoL" }}>
      ...
      <div className="w-full md:w-100 h-auto ml-0 md:ml-5 flex flex-col  items-center mt-1 ">
        <div className="flex">
          <a
